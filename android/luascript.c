...
/*	lua_pushcfunction(L,l_SE_screen_init);
	...
	lua_register(L,"SE_tilemap_area_draw",l_SE_tilemap_area_draw);
	lua_register(L,"SE_tilemap_area_collision",l_SE_tilemap_area_collision);
	lua_register(L,"SE_tilemap_area_sprite_collision",l_SE_tilemap_area_sprite_collision);
...
static int l_SE_tilemap_area_draw(lua_State *L)
{
	...
	float tm_posx = lua_tonumber(L,2);
	float tm_posy = lua_tonumber(L,3);
	float tm_posz = lua_tonumber(L,4);

	SE_box *area = (SE_box*)lua_touserdata(L,5);
	
	SE_tilemap_area_draw(tm,tm_posx,tm_posy,tm_posz,area);
...
static int l_SE_tilemap_area_collision(lua_State *L)
{
	...
	SE_box *area = (SE_box*)lua_touserdata(L,4);

	SE_box *box = (SE_box*)lua_touserdata(L,5);

	float box_posx = lua_tonumber(L,6);
	float box_posy = lua_tonumber(L,7);
	
	int value = SE_tilemap_area_collision(tm,tm_posx,tm_posy,area,box,box_posx,box_posy);
...
static int l_SE_tilemap_area_sprite_collision(lua_State *L)
{
	...
	SE_sprite *spr = (SE_sprite*)lua_touserdata(L,5);

	float spr_posx = lua_tonumber(L,6);
	float spr_posy = lua_tonumber(L,7);
	
	int value = SE_tilemap_area_sprite_collision(tm,tm_posx,tm_posy,area,spr,spr_posx,spr_posy);
